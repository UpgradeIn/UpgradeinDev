...
const Pricing = () => {
    return (
        <>
            <Head title="Upgradein - Daftar Harga" />
            <div className="flex flex-col items-center pt-24 pb-10 px-5 lg:pb-32 lg:pt-32 lg:grid-cols-2 lg:min-h-screen sm:px-10">
                <div className="space-y-5 sm:space-y-16">
                    <div className="flex flex-col items-center space-y-3">
                        ...
                        <p className="max-w-lg text-md text-center text-gray-600">
                            Kami menyediakan berbagai macam paket yang dapat
